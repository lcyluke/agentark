...
from agentark.interface.middleware import (
...
def create_app():
    ...
    # ── Imports ────────────────────────────────────────────────
    from agentark.core.profile import ProfileManager, AGENTARK_HOME, Profile, SoulConfig
    ...
    from agentark.economy import BudgetManager

    pm = ProfileManager()
    economy_db = AGENTARK_HOME / "economy.db"
    evolution_db = AGENTARK_HOME / "evolution.db"
    knowledge_db = AGENTARK_HOME / "knowledge.db"
    ...
    def api_analytics_costs():
        ...
        try:
            from agentark.interface.hermes_bridge import get_hermes_session_stats
    ...
    @request_logger
    def api_companies():
        companies_dir = AGENTARK_HOME / "companies"
    ...
    def api_autonomous():
        try:
            from agentark.orchestration.autonomous import get_engine
            eng = get_engine()
    ...
    def api_hermes_status():
        try:
            from agentark.interface.hermes_bridge import get_hermes_session_stats, get_hermes_cron_status, get_hermes_profile_status
            return jsonify({
    ...
    def api_gpu_status():
        try:
            from agentark.interface.gpu_manager import get_gpu_status
    ...
    def api_models_pricing():
        try:
            from agentark.interface.hermes_bridge import get_model_pricing
    ...
    def api_cost_summary():
        """💰 成本总览"""
        try:
            from agentark.cost_tracker import get_summary
    ...
    def api_cost_cron():
        """📋 每个Cron任务的成本明细"""
        try:
            from agentark.cost_tracker import get_cron_costs
    ...
    def api_cost_agents():
        ...
        try:
            from agentark.cost_tracker import get_agent_costs
            days = request.args.get("days", 30, type=int)
    ...
    def api_cost_sources():
        """📡 按来源渠道分解"""
        try:
            from agentark.cost_tracker import get_source_breakdown
            days = request.args.get("days", 30, type=int)
    ...
    def api_cost_projects():
        """📦 按项目聚合成本"""
        try:
            from agentark.cost_tracker import estimate_project_costs
    ...
    def api_cost_timeline():
        """📈 成本趋势 (hourly/daily)"""
        try:
            from agentark.cost_tracker import get_timeline
    ...
    def api_cost_full():
        """📊 完整成本快照 (Dashboard用)"""
        try:
            from agentark.cost_tracker import get_full_snapshot
    ...
    def api_command_center():
        try:
            from agentark.interface.hermes_bridge import get_command_center_data
    ...
    def get_router():
        nonlocal _router
        if _router is None:
            from agentark.orchestration.message_router import MessageRouter
    ...
    def api_openclaw_status():
        ...
        try:
            from agentark.interface.openclaw_bridge import get_status_summary
    ...
    def api_openclaw_tools():
        ...
        try:
            from agentark.interface.openclaw_bridge import get_available_tools
    ...
    def api_openclaw_run():
        ...
        from agentark.interface.openclaw_bridge import (
    ...
    def api_openclaw_workflows():
        ...
        try:
            from agentark.interface.openclaw_bridge import get_workflows
    ...
    def get_auth_engine():
        ...
        if _auth_engine is None:
            from agentark.orchestration.authorization import AuthorizationEngine
    ...
    def api_fleet_profiles_list():
        ...
        try:
            from agentark.interface.fleet_manager import list_hermes_profiles
    ...
    def api_fleet_profile_detail(name: str):
        ...
        try:
            from agentark.interface.fleet_manager import get_profile_detail, update_profile, delete_profile
    ...
    def api_fleet_profile_toggle(name: str):
        ...
        try:
            from agentark.interface.fleet_manager import toggle_profile
    ...
    def api_fleet_profile_copy(name: str):
        ...
        try:
            from agentark.interface.fleet_manager import copy_profile
            data = request.get_json(force=True) or {}
    ...
    def api_fleet_create_profile():
        ...
        try:
            from agentark.interface.fleet_manager import create_profile
            data = request.get_json(force=True) or {}
            name = data.get("name", "")
    ...
    def api_fleet_teams_list():
        ...
        try:
            from agentark.interface.fleet_manager import list_teams
    ...
    def api_fleet_create_team():
        ...
        try:
            from agentark.interface.fleet_manager import create_team
            data = request.get_json(force=True) or {}
    ...
    def api_fleet_team_detail(name: str):
        ...
        try:
            from agentark.interface.fleet_manager import update_team, delete_team, get_team_org_chart
            if request.method == "GET":
    ...
    def api_gpu_projects():
        ...
        try:
            from agentark.interface.gpu_manager import get_gpu_projects
    ...
    def api_gpu_bind_project():
        ...
        try:
            from agentark.interface.gpu_manager import bind_project
            data = request.get_json(force=True) or {}
            project = data.get("project", "")
    ...
    def api_gpu_shutdown_request():
        ...
        try:
            from agentark.interface.gpu_manager import request_shutdown
            data = request.get_json(force=True) or {}
            project = data.get("project", "")
    ...
    def api_gpu_shutdown_confirm():
        ...
        try:
            from agentark.interface.gpu_manager import confirm_shutdown
            data = request.get_json(force=True) or {}
            code = data.get("code", "")
            if not code:
    ...
    def api_pipeline_normal():
        ...
        try:
            ...
            from agentark.orchestration.pipeline import run_normal_pipeline
            from agentark.orchestration.task_manager import get_task_manager
    ...
    def api_pipeline_direct():
        ...
        try:
            ...
            from agentark.orchestration.pipeline import run_direct_pipeline, resolve_agent
            from agentark.orchestration.task_manager import get_task_manager
    ...
    def api_pipeline_smart():
        ...
        try:
            ...
            from agentark.orchestration.pipeline import smart_route
            from agentark.orchestration.task_manager import get_task_manager
    ...
    def api_agent_workloads():
        ...
        try:
            from agentark.interface.project_ops import get_agent_workloads
    ...
    def api_match_task():
        ...
        try:
            from agentark.interface.project_ops import match_task_to_agent, auto_assign_task
            data = request.get_json(force=True) or {}
    ...
    def api_standup():
        ...
        try:
            from agentark.interface.project_ops import generate_standup_report
    ...
    def api_knowledge_search():
        ...
        try:
            from agentark.interface.project_ops import search_solutions, get_knowledge_base_stats
    ...
    def api_knowledge_record():
        ...
        try:
            from agentark.interface.project_ops import record_solution
            data = request.get_json(force=True) or {}
    ...
    def api_live_runtime():
        ...
        try:
            from agentark.interface.live_status import get_hermes_runtime
    ...
    def api_live_projects():
        ...
        try:
            from agentark.interface.live_status import list_projects
    ...
    def api_live_project_dashboard(project: str):
        ...
        try:
            from agentark.interface.live_status import get_project_dashboard
    ...
    def api_live_task_standup(task_id: str):
        ...
        try:
            from agentark.interface.live_status import generate_task_completion_standup
    ...
    def api_sprint_list():
        """List all sprints."""
        try:
            from agentark.orchestration.sprint_pipeline import SprintManager
            mgr = SprintManager()
    ...
    def api_projects_approved():
        ...
        try:
            from agentark.interface.project_registry import list_approved_projects
    ...
    def api_project_detail(name: str):
        ...
        try:
            from agentark.interface.project_registry import get_project_detail
    ...
    def api_project_propose():
        ...
        try:
            from agentark.interface.project_registry import propose_project
            data = request.get_json(force=True) or {}
    ...
    def api_project_approve():
        ...
        try:
            from agentark.interface.project_registry import approve_project
            data = request.get_json(force=True) or {}
    ...
    def api_project_add_module():
        ...
        try:
            from agentark.interface.project_registry import add_project_module
            data = request.get_json(force=True) or {}
    ...
    def api_project_add_subfunction():
        ...
        try:
            from agentark.interface.project_registry import add_sub_function
            data = request.get_json(force=True) or {}
    ...
    def api_agent_profile(agent_id: str):
        ...
        try:
            from agentark.interface.project_registry import get_agent_profile
    ...
    def api_agents_summary():
        """All agent summaries"""
        try:
            from agentark.interface.project_registry import get_all_agent_summaries
    ...
    def api_modules():
        ...
        try:
            from agentark.interface.project_factory import get_module_library, search_modules
            q = request.args.get("q", "")
            cat = request.args.get("category", "")
            if q:
                return jsonify(search_modules(q))
            if cat:
                from agentark.interface.project_factory import get_module_templates
    ...
    def api_skills_agent(agent_id: str):
        ...
        try:
            from agentark.interface.project_factory import get_agent_skills
    ...
    def api_skills_award():
        ...
        try:
            from agentark.interface.project_factory import award_xp
            data = request.get_json(force=True) or {}
    ...
    def api_skills_leaderboard():
        ...
        try:
            from agentark.interface.project_factory import get_skill_leaderboard
    ...
    def api_pipeline(project: str):
        ...
        try:
            from agentark.interface.project_factory import get_project_pipeline, get_project_evaluation
    ...
    def api_audit_queue():
        try:
            from agentark.interface.audit_flow import get_approval_queue
    ...
    def api_audit_approve():
        try:
            from agentark.interface.audit_flow import approve_item
    ...
    def api_audit_reject():
        try:
            from agentark.interface.audit_flow import reject_item
            d = request.get_json(force=True) or {}
    ...
    def api_audit_log():
        try:
            from agentark.interface.audit_flow import get_audit_log, get_audit_stats
    ...
    def api_flow_timeline():
        try:
            from agentark.interface.audit_flow import get_data_flow_timeline
            project = request.args.get("project", None)
