...
from agentark.core.profile import ProfileManager, Profile
from agentark.orchestration.swarm import Swarm
from agentark.orchestration.crew import Crew
from agentark.orchestration.chain import Chain
from agentark.orchestration.router import Router
...
def get_status_summary() -> dict:
    ...
    from agentark.core.knowledge import KnowledgeGraph
    from agentark.economy import BudgetManager, AGENTARK_HOME
    
    evo = EvolutionEngine()
    kg = KnowledgeGraph()
    
    try:
        eco = BudgetManager(AGENTARK_HOME / "economy.db")
