...
from agentark.interface.agent_monitor import (
...
def inspect_cmd(project: str = "", pm: str = ""):
    ...
    console.print(f"\n[bold cyan]⚓ 舰队巡检中...[/]")
    if project:
        from agentark.orchestration.pipeline import PROJECT_AGENT_MAP
...
def deploy_cmd(
    ...
    # 舰队状况
    from agentark.interface.agent_monitor import get_monitor
    monitor = get_monitor()
    ...
    from agentark.cli.commands.squad_cmds import DEV_SQUAD
...
def fleet_init_cmd(
    ...
    from agentark.interface.fleet_multi_mac import fleet_init, get_machine_id
...
def fleet_join_cmd(force: bool = False):
    ...
    from agentark.interface.fleet_multi_mac import fleet_join, get_machine_id
...
def fleet_sync_cmd(direction: str = "pull"):
    ...
    from agentark.interface.fleet_multi_mac import fleet_sync, get_fleet_config
...
def fleet_nodes_cmd():
    ...
    from agentark.interface.fleet_multi_mac import fleet_status as multi_status, get_fleet_config, get_all_nodes
    from rich.table import Table
...
def fleet_gpu_status_cmd():
    ...
    from agentark.interface.fleet_multi_mac import get_fleet_config, get_all_nodes, _probe_gpu
    from rich.table import Table
    from rich.panel import Panel
    import subprocess
    from pathlib import Path as P
...
def fleet_report_cmd():
    ...
    from agentark.interface.fleet_multi_mac import fleet_report, get_fleet_config, fleet_status
...
def fleet_probe_cmd():
    ...
    from agentark.fleet.scheduler import NodeProber
    from rich.table import Table
...
def fleet_dispatch_cmd(
    ...
    """
    from agentark.fleet.scheduler import (
...
def fleet_queue_cmd():
    ...
    from agentark.fleet.scheduler import TaskQueue
    from rich.table import Table
