...
class ClaudeCodeAdapter:
    ...
    Constructor:
        ClaudeCodeAdapter(agentark_home: Path | None = None)
    """

    def __init__(self, agentark_home: Path | str | None = None):
        """Initialize the Claude Code adapter.

        Args:
            agentark_home: Root directory for Apex data (used as base workdir).
        """
        self._agentark_home = Path(agentark_home) if agentark_home else Path.home() / ".apex"
        self._sessions: dict[str, ClaudeSession] = {}
        self._workdir_base = self._agentark_home / "claude-sessions"
