...
class TestReplicate:
    def test_replicate_merge(self):
        ...
        os.environ["APEX_HOME"] = str(tmp)
        try:
            from apex.orchestration.origin import OriginAgent, PM_SKILLS
            from apex.core.profile import ProfileManager, Profile, SoulConfig
