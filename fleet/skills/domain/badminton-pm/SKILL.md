...
- **域名**: badminton.chat ✅
- **服务器**: 腾讯云 43.139.191.202 (TencentOS 3.3, x86_64, 2C/2G/50G)
- **部署**: 进行中 — 旧版(5月)在 /data/badminton/ 运行中，待替换为 v0.4.1
- **微信审核**: 未提交

> 服务器已有 nginx 1.14.1 + Python 3.11.9。旧服务 uvicorn 在 127.0.0.1:8000。部署详见 `badminton-deploy` skill。
